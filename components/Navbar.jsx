...
const Navbar = () => {
  ...
  const [navBg, setNavBg] = useState('#041c2f');
  const [linkColor, setLinkColor] = useState('#69a4ec');
    ...
    >
      <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className='hidden md:flex'>
            ...
            <li className='ml-10 text-sm font-bold uppercase hover:border-b'>
              <Link href='/#projects'>Subjects</Link>
            </li>
            <li className='ml-10 text-sm font-bold uppercase hover:border-b'>
      ...
      >
        ...
        <div
          className={
            nav
              ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#80afbc] p-10 ease-in duration-500'
        ...
        >
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-40'>
              <p className='uppercase tracking-widest text-[#dbdbe8]'>
                Let&#39;s Connect
              </p>
